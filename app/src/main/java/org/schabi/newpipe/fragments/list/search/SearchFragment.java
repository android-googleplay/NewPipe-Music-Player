...
public class SearchFragment extends BaseListFragment<SearchInfo, ListExtractor.InfoItemsPage<?>>
    ...
    public void onCreateOptionsMenu(@NonNull final Menu menu,
        ...
        final MenuItem item2 = menu.findItem(5);
        final List<String> cf = new ArrayList<>(1);
        cf.add(String.valueOf(5));
        changeContentFilter(item2, cf);
    ...
    public void startLoading(final boolean forceLoad) {
        ...
        final MenuItem item2 = men.findItem(5);
        if(String.valueOf(item2.isChecked()) == "true"){
            searchDisposable = ExtractorHelper.searchFor(serviceId,
                            searchString,
                            Arrays.asList("music_songs"),
                            sortFilter)
                    .subscribeOn(Schedulers.io())
                    .observeOn(AndroidSchedulers.mainThread())
